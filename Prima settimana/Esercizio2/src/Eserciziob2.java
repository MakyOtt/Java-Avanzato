...
public class Eserciziob2 {
    ...
    private static void exercise1() {
        ...
        myFirstMap.put(28,"marika");
        myFirstMap.put(26,"teresa");
        myFirstMap.put(17,"francesco");
        // 1c. Print the map
    ...
    private static void exercise3() {
        ...
        for( Map.Entry<String,Integer> frutta : fruitWeights.entrySet()){
            totalWeight+=frutta.getValue();
        }
